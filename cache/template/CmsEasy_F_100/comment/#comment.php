...
<?php echo lang('username');?>：<input type="text" name="username" class="input_d" value="<?php echo get('username');?>"/> &nbsp;&nbsp;<?php if(config::get('verifycode')){?><?php echo lang('verifycode');?>：<?php echo verify();?> &nbsp;<input type="text" name="verify" value="" class="input_c" />&nbsp;<?php } ?><input name="submit" class="btn" value="<?php echo lang('submit_on');?>" type="submit"/>
</div>
</form>
