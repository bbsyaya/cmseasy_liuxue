...
<style type="text/css">
.izl-rmenu{position:fixed; <?php echo $_float;?> margin-right:20px; bottom:0px; padding-bottom:0px; background:url(<?php echo $skin_path;?>/images/servers/metro_color/r_b.png) 0px bottom no-repeat; z-index:999; }
