...
<td align="left" style="padding-left:10px;" class="catname"><?php echo $d['typename'];?> <?php if(isset($data1)){?><a onclick="child(this)" title="点击展开/收起" class="child"><span class="glyphicon glyphicon-indent-left"></span></a><?php } ?></td>
