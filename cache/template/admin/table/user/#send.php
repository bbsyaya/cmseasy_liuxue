...
<li class="active"><a href="<?php echo $base_url;?>/index.php?case=table&act=send&table=user&admin_dir=<?php echo get('admin_dir');?>&site=default">发送邮件</a></li>
<li><a href="<?php echo $base_url;?>/index.php?case=table&act=mail&table=user&admin_dir=<?php echo get('admin_dir');?>&site=default">注册会员群发</a></li>
...
<textarea name="mail_address" id="mail_address" class="form-control textarea"><?php if($st) {?><?php echo table_user::mail_before();?><?php }?><?php if(front::get('type')=='subscription'){ echo $maillist; }?></textarea>
