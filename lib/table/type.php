...
class type extends table
{
    ...
    {
        if ($act == 'modify')
            return 'typeid,parentid,listorder,typename,subtitle,htmldir,template,listtemplate,showtemplate,ishtml,isshow,ispages,includecatarchives,linkto,htmlrule,listhtmlrule,showhtmlrule,description,keyword,stype,thumb,thumb_width,thumb_height';
